      ...
      <section className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-[family-name:var(--font-display)] text-4xl font-semibold mb-4">
            Atrakcja nie znaleziona
          </h1>
          <a href="/atrakcje" className="btn-outline">Wróć do atrakcji</a>
        </div>
      </section>
    );
  }
    ...
    <>
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 pt-28 sm:pt-32">
        ...
        >
          ...
          <span className="text-sm font-medium" style={{ fontFamily: "var(--font-body)" }}>Wszystkie atrakcje</span>
        </a>
