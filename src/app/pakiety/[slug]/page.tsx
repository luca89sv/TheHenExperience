            ...
            >
              {inCart ? (
                <>
                  ...
                  <span className="text-[10px] font-medium group-hover/cart:hidden" style={{ fontFamily: "var(--font-body)" }}>W koszyku</span>
                  <span className="text-[10px] font-medium hidden group-hover/cart:inline" style={{ fontFamily: "var(--font-body)" }}>Usuń</span>
                </>
              ) : (
    ...
    return (
      <section className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <a href="/pakiety" className="btn-outline">Wróć do pakietów</a>
        </div>
      </section>
    );
  }
    ...
    <>
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 pt-28 sm:pt-32">
        ...
        >
          ...
          <span className="text-sm font-medium" style={{ fontFamily: "var(--font-body)" }}>Wszystkie pakiety</span>
        </a>
          ...
          return suggested.length > 0 ? (
            <div className="mt-16 pt-12 border-t border-white/6">
              <h2 className="font-[family-name:var(--font-display)] text-2xl sm:text-3xl font-semibold mb-3">
                Uzupełnij sw&oacute;j <em>wiecz&oacute;r</em>
              </h2>
              <p className="text-white/35 text-sm mb-8" style={{ fontFamily: "var(--font-body)" }}>
                Dodaj pojedyncze atrakcje, kt&oacute;re nie s&#261; cz&#281;&#347;ci&#261; tego pakietu
              </p>
